// AUTO-GENERATED snippet snapshot for v0.12.0 — do not edit manually.
// Snippet IDs extracted from versioned_docs/version-0.12.0/**/*.mdx
...
# Windows PowerShell
notepad "$env:APPDATAinvowkconfig.cue"`,
  },
  'config/full-example': {
    language: 'cue',
        ...
        script: """
            ...
            if [ -n "$INVOWK_ARG_SERVICES" ]; then
                for i in $(seq 1 $INVOWK_ARG_SERVICES_COUNT); do
                    service=$(printenv "INVOWK_ARG_SERVICES_$i")
