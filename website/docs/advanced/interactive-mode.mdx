...
:::note
Interactive mode only works with the **native runtime**. Virtual and container runtimes do not support this mode.
:::
...
- **Native runtime only**: Virtual and container runtimes don't support interactive mode
