...
- Required `invkpack.cue` at root
- `invkfile.cue` is optional (library-only packs are allowed)
- No nested packs (except inside `invk_packs/`)
...
- Pack ID in `invkpack.cue` matches the folder name prefix
