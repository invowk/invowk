...
Each finding includes `code`, `severity`, `category`, `surface_id`, `surface_kind`, `checker_name`, optional `file_path`/`line`, `title`, `description`, `recommendation`, and optional escalation provenance fields.
