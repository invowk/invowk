...
| **EnvContext** | Groups environment configuration: `ExtraEnv` (INVOWK_FLAG_\*, INVOWK_ARG_\*), `RuntimeEnvVars` (--invk-env-var), `RuntimeEnvFiles` (--invk-env-file), and inheritance overrides. |
...
| 9 | `--invk-env-file` flag |
| 10 | `--invk-env-var` flag (highest priority) |
