...
Overrides the default namespace for this dependency. Aliases use command source ID rules: they must start with a letter and may contain letters, digits, `.`, `_`, or `-`.
