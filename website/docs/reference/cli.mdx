...
| `--pack-id` | `-g` | Pack identifier for `invkpack.cue` (default: pack name) |
| `--description` | `-d` | Description for `invkpack.cue` |
...
Manage pack aliases for collision disambiguation.
...
Resolve a pack dependency and print the `requires` entry for `invkpack.cue`.
...
| Flag | Description |
|------|-------------|
| `--alias` | Alias for the pack namespace |
| `--path` | Subdirectory path within the repository |

#### invowk pack remove

Remove a pack dependency from the lock file.

<Snippet id="reference/cli/pack-remove-syntax" />

#### invowk pack sync

Sync dependencies from `invkpack.cue`.

<Snippet id="reference/cli/pack-sync-syntax" />

#### invowk pack update

Update pack dependencies to latest matching versions.

<Snippet id="reference/cli/pack-update-syntax" />

#### invowk pack deps

List resolved pack dependencies.

<Snippet id="reference/cli/pack-deps-syntax" />

#### invowk pack vendor

Vendor dependencies into `invk_packs/`.
...
| `--prune` | Remove unused vendored packs |
