...
Container runtime fully supports interactive mode (`-i`). When running interactively, Invowk automatically provisions its binary into the container, enabling:
...
1. **Auto-provisions** the invowk binary into the container
