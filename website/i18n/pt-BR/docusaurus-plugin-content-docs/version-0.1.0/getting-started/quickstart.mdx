...
Isso cria um `invowkfile.cue` com um comando de exemplo. Vamos dar uma olhada:

<Snippet id="quickstart/hello-invowkfile" />
...
Edite seu `invowkfile.cue` para adicionar um comando mais útil:
