...
| **Provedores LLM Opcionais** | Análise com LLM para `invowk audit` e autoria de comandos com `invowk agent cmd create` via Claude, Codex/OpenAI, Gemini ou Ollama local. | APIs HTTP compatíveis com OpenAI / CLIs locais |
