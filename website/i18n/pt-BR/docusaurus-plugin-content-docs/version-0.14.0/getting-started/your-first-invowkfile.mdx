...
O comando `test unit` permite tanto o runtime `native` quanto o `virtual-sh`:
...
- [Conceitos Principais](../core-concepts/invowkfile-format) - Mergulho profundo no formato do invowkfile
- [Modos de Runtime](../runtime-modes/overview) - Aprenda sobre runtimes native, virtual-sh, virtual-lua e container
