...
|------------|------------|------------------|
| **Engine** | Interface Go | Contrato de 11 métodos para operações de container: `Name`, `Available`, `Version`, `Build`, `Run`, `Remove`, `ImageExists`, `RemoveImage`, `BinaryPath`, `BuildRunArgs`, `PrepareRunCommand`. Todas as funções factory retornam este tipo. |
