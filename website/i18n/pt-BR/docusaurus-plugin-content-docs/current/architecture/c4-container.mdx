...
| **Execution Orchestrator** | Go | Seleção de runtime e construção do contexto de execução (`internal/app/execute/`). Escolhe o runtime selecionado e despacha para as implementações de runtime. |
