...
| **LuaRuntime** | Go/golua | Runtime Lua embarcado com o harness de segurança virtual compartilhado. Implementa Runtime e CapturingRuntime. |
...
Native, Sh e Container implementam a interface interativa; Lua atualmente implementa execução e captura.
