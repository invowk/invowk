...
| `invowk module vendor` | Faz vendor das dependências em `invk_mods/` (parcial) |
...
Faz vendor das dependências no diretório `invk_mods/` para uso offline e distribuição.
