...
O modo interativo funciona perfeitamente com o runtime container. Quando você executa um comando de container com `-i`:

1. **Auto-provisionamento**: Invowk provisiona seu binário no container
