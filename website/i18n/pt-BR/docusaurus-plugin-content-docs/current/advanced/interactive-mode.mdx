...
Imagens baseadas em Alpine não são suportadas — ambientes baseados em musl possuem diferenças comportamentais sutis que reduzem a confiabilidade do runtime. Use imagens baseadas em Debian (ex: `debian:stable-slim`) ou imagens específicas de linguagem (ex: `python:3-slim`).
:::
