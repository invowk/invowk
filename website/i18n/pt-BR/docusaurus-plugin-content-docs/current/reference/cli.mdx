...
| `--llm-model` | `qwen2.5-coder:7b` | Nome do modelo LLM |
...
`--dry-run` e `--print` são mutuamente exclusivos. `--verify` exige escrever o invowkfile e não pode ser combinado com `--dry-run` ou `--print`.
