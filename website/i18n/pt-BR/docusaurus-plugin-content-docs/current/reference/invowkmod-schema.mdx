...
Os limites de strings são medidos em pontos de código Unicode (runes):

| Campo | Máximo de runes |
|---|---:|
| `module` | 256 |
| `version` raiz | 64 |
| `description` | 10.240 |
...
| `license` | 128 |
| `repository` | 2.048 |
| `git_url` da dependência | 2.048 |
| `version` da dependência | 64 |
| `alias` da dependência | 256 |
| `path` da dependência | 4.096 |
