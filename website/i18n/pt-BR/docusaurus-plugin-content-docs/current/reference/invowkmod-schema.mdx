...
Subdiretório dentro do repositório que contém o módulo. Deve ser relativo, não pode conter sequências de travessia de caminho e deve apontar diretamente para um diretório cujo basename termina em `.invowkmod`. O prefixo do basename deve corresponder ao valor `module` do módulo selecionado.
