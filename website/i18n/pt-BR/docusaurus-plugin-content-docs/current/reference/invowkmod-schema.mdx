...
URL do repositório Git. Formas aceitas: HTTPS (`https://...`), SSH shorthand (`git@...`) ou URI SSH (`ssh://...`). O repositório deve conter um módulo.
...
Sobrescreve o namespace padrão para esta dependência. Aliases usam regras de command source ID: devem começar com uma letra e podem conter letras, dígitos, `.`, `_` ou `-`.
