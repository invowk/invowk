...
- **Mesmo invkfile**: você pode referenciar comandos sem o prefixo do grupo (ex.: `"build"`, `"test unit"`). O Invowk resolve isso usando o `group` do invkfile atual.
- **Outros invkfiles / packs**: use o nome completo com prefixo de grupo (ex.: `"shared generate-types"`).
...
Isso é especialmente útil quando seu invkfile espera que outro invkfile/pack esteja instalado.
