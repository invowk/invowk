...
Diretórios adicionais para buscar invkfiles e packs. Caminhos são buscados em ordem após o diretório atual.
...
Habilita o provisionamento automático do binário do invowk e packs dentro dos containers.
...
Diretórios adicionais de packs para provisionar dentro dos containers.
