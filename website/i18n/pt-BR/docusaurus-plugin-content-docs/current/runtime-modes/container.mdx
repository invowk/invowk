...
O runtime container suporta totalmente o modo interativo (`-i`). Ao executar interativamente, o Invowk provisiona automaticamente seu binário no container, habilitando:
...
1. **Auto-provisiona** o binário invowk no container
