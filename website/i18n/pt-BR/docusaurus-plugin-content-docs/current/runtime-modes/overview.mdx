...
| virtual-sh | Shell integrado com utilitários core |
| virtual-lua | Lua integrado e helpers explicitamente permitidos |
...
- **virtual-sh**: O `go` está disponível como utilitário integrado ou binário do host explicitamente permitido?
- **virtual-lua**: O `go` está disponível por um helper explicitamente permitido da ponte Lua?
