...
Por padrão, os runtimes native, virtual-sh e virtual-lua herdam o ambiente do host, enquanto o runtime container começa sem variáveis do host. Você pode controlar isso por runtime ou por execução.
...
| `INVOWK_RUNTIME` | Nome do runtime resolvido (`native`, `virtual-sh`, `virtual-lua`, `container`) | Sim |
