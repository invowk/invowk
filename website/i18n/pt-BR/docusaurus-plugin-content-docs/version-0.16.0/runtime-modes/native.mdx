...
Por padrão, scripts rodam a partir do diretório que contém o invowkfile. Comandos carregados de um módulo rodam a partir da raiz do módulo. Sobrescreva esse comportamento com `workdir`:
...
- [Runtime Virtual-Sh](./virtual) - Para consistência multiplataforma
