...
Isso imprime seus caminhos de configuração (diretório de configuração, arquivo de configuração e diretório de comandos). Prático quando você quer encontrar e editar sua configuração diretamente.
