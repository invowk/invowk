...
| **Provedores LLM Opcionais** | Análise com LLM para `invowk audit` via Claude, Codex/OpenAI, Gemini ou Ollama local. | APIs HTTP compatíveis com OpenAI / CLIs locais |
