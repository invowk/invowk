...
| 8-9 | Discovery | Escanear fontes configuradas, provisionadas, de usuário e módulos vendorizados de um nível |
...
4. Entradas de módulos provisionadas pelo adaptador de comando
5. Entradas de módulos globais provisionadas pelo adaptador de comando
6. Diretório de comandos do usuário `~/.invowk/cmds/` (apenas módulos, não recursivo)
