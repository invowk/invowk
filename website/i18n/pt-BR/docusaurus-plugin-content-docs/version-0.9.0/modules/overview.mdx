...
| `invowk module tidy` | Adicionar dependências transitivas faltantes ao `invowkmod.cue` |
| `invowk module deps` | Listar dependências resolvidas a partir do lock file |
