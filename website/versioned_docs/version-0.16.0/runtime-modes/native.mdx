...
By default, scripts run from the directory containing the invowkfile. Commands loaded from a module run from the module root. Override this with `workdir`:
...
- [Virtual-Sh Runtime](./virtual) - For cross-platform consistency
