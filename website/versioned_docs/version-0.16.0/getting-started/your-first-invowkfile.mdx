...
The `test unit` command allows both `native` and `virtual-sh` runtimes:
...
- [Runtime Modes](../runtime-modes/overview) - Learn about native, virtual-sh, virtual-lua, and container runtimes
