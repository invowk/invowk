...
| `ivk-env-inherit-allow` | | Allowlist host env vars to inherit; requires `ivk-env-inherit-mode=allow` |
...
| `ivk-container-name` | | Override persistent container target name (container runtime only) |
