...
The default template gives you a single `hello` command with four implementations: native (Linux/macOS), native (Windows), virtual (all platforms), and container (Linux only). Each implementation declares which platforms it supports.
