...
- **Modules**: use the module-prefixed name (or alias) as shown by `invowk cmd --list` (e.g., `"shared generate-types"`).
...
This is especially useful when your invkfile expects another invkfile/module to be installed.
