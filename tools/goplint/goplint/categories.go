...
func diagnosticCategoryRegistry() []CategorySpec {
	return []CategorySpec{
		...
		{Name: CategoryUnvalidatedCastInconclusive, BaselinePolicy: BaselineSuppressible, BaselineLabel: "Type conversions to DDD types with inconclusive Validate() path analysis"},
		...
		{Name: CategoryMissingConstructorValidateInc, BaselinePolicy: BaselineSuppressible, BaselineLabel: "Constructors returning validatable types with inconclusive Validate() path analysis"},
		...
		{Name: CategoryUseBeforeValidateSameBlock, BaselinePolicy: BaselineSuppressible, BaselineLabel: "DDD Value Type values used before Validate() in same block"},
		{Name: CategoryUseBeforeValidateCrossBlock, BaselinePolicy: BaselineSuppressible, BaselineLabel: "DDD Value Type values used before Validate() across blocks"},
		{Name: CategoryUseBeforeValidateInconclusive, BaselinePolicy: BaselineSuppressible, BaselineLabel: "DDD Value Type values with inconclusive use-before-validate analysis"},
