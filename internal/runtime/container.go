...
// 1. Command-level env.files (loaded in array order)
// 2. Implementation-level env.files (loaded in array order)
// 3. Command-level env.vars (inline static variables)
// 4. Implementation-level env.vars (inline static variables)
// 5. ExtraEnv: INVOWK_FLAG_*, INVOWK_ARG_*, ARGn, ARGC
// 6. --env-file flag files (loaded in flag order)
// 7. --env-var flag values (KEY=VALUE pairs) - HIGHEST priority
