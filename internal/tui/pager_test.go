...
// TestPagerModel_UnicodeAndLongInputs is a crash-guard test: Init() and View()
// must not panic when the title or content contains non-ASCII or long content.
func TestPagerModel_UnicodeAndLongInputs(t *testing.T) {
	t.Parallel()
