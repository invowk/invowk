---
name: tui-testing
description: VHS-based visual debugging workflow for Invowk TUI demos and screenshots. Use tmux-testing for durable CI TUI tests.
---
...
```tape
Output /tmp/invowk-tui-debug.gif
Set Shell "bash"
Set Width 1000
Set Height 700
Set TypingSpeed 20ms

Type "go run . tui choose 'Option A' 'Option B' 'Option C'"
Enter
Sleep 300ms
Screenshot /tmp/invowk-tui-initial.png
Down
Sleep 150ms
Screenshot /tmp/invowk-tui-after-down.png
Enter
Sleep 150ms
```
