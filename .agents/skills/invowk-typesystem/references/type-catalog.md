...
- `IsValid()` value types: 110
- Primitive-wrapper + `IsValid()` types: 86
- Composite validator + `IsValid()` types: 24
...
| `ColorScheme` | `primitive-wrapper` | `internal/config/types.go:501` |
| `Config` | `composite-validator` | `internal/config/types.go:337` |
| `ContainerConfig` | `composite-validator` | `internal/config/types.go:314` |
| `ContainerEngine` | `primitive-wrapper` | `internal/config/types.go:453` |
...
| `RuntimeMode` | `primitive-wrapper` | `internal/config/types.go:477` |
| `UIConfig` | `composite-validator` | `internal/config/types.go:262` |
| `BuildOptions` | `composite-validator` | `internal/container/engine.go:318` |
| `ContainerID` | `composite-validator` | `internal/container/engine.go:230` |
| `ContainerName` | `composite-validator` | `internal/container/engine.go:270` |
| `EngineType` | `primitive-wrapper` | `internal/container/engine.go:385` |
| `HostMapping` | `primitive-wrapper` | `internal/container/engine.go:293` |
| `ImageTag` | `primitive-wrapper` | `internal/container/engine.go:250` |
| `RunOptions` | `composite-validator` | `internal/container/engine.go:346` |
| `HostFilesystemPath` | `primitive-wrapper` | `internal/container/engine_base.go:278` |
| `MountTargetPath` | `primitive-wrapper` | `internal/container/engine_base.go:298` |
| `NetworkPort` | `primitive-wrapper` | `internal/container/engine_base.go:258` |
| `PortMapping` | `composite-validator` | `internal/container/engine_base.go:367` |
| `PortProtocol` | `primitive-wrapper` | `internal/container/engine_base.go:218` |
| `SELinuxLabel` | `primitive-wrapper` | `internal/container/engine_base.go:241` |
| `VolumeMount` | `composite-validator` | `internal/container/engine_base.go:327` |
| `State` | `primitive-wrapper` | `internal/core/serverbase/state.go:71` |
| `Diagnostic` | `composite-validator` | `internal/discovery/diagnostic.go:247` |
| `DiagnosticCode` | `primitive-wrapper` | `internal/discovery/diagnostic.go:193` |
| `Severity` | `primitive-wrapper` | `internal/discovery/diagnostic.go:149` |
...
| `HttpLink` | `primitive-wrapper` | `internal/issue/issue.go:240` |
| `Id` | `primitive-wrapper` | `internal/issue/issue.go:190` |
| `MarkdownMsg` | `primitive-wrapper` | `internal/issue/issue.go:218` |
| `Config` | `composite-validator` | `internal/provision/config.go:77` |
...
| `Config` | `composite-validator` | `internal/sshserver/server.go:109` |
| `HostAddress` | `primitive-wrapper` | `internal/sshserver/types.go:65` |
| `TokenValue` | `primitive-wrapper` | `internal/sshserver/types.go:77` |
...
| `SelectionIndex` | `primitive-wrapper` | `internal/tui/selection_index.go:29` |
| `SpinnerType` | `primitive-wrapper` | `internal/tui/spin.go:129` |
| `TerminalDimension` | `primitive-wrapper` | `internal/tui/terminal_dimension.go:33` |
...
| `AuthToken` | `primitive-wrapper` | `internal/tuiserver/types.go:31` |
| `Config` | `composite-validator` | `internal/watch/watcher.go:133` |
| `ArgumentName` | `primitive-wrapper` | `pkg/invowkfile/argument.go:111` |
...
| `CommandCategory` | `primitive-wrapper` | `pkg/invowkfile/command.go:108` |
| `CommandName` | `primitive-wrapper` | `pkg/invowkfile/command.go:87` |
| `ContainerfilePath` | `primitive-wrapper` | `pkg/invowkfile/containerfile_path.go:33` |
| `BinaryName` | `primitive-wrapper` | `pkg/invowkfile/dependency.go:226` |
| `CheckName` | `primitive-wrapper` | `pkg/invowkfile/dependency.go:245` |
| `ScriptContent` | `primitive-wrapper` | `pkg/invowkfile/dependency.go:265` |
| `DotenvFilePath` | `primitive-wrapper` | `pkg/invowkfile/dotenv_path.go:33` |
| `DurationString` | `primitive-wrapper` | `pkg/invowkfile/duration.go:39` |
| `EnvVarName` | `primitive-wrapper` | `pkg/invowkfile/env.go:55` |
| `FlagName` | `primitive-wrapper` | `pkg/invowkfile/flag.go:128` |
| `FlagShorthand` | `primitive-wrapper` | `pkg/invowkfile/flag.go:156` |
| `FlagType` | `primitive-wrapper` | `pkg/invowkfile/flag.go:109` |
| `PlatformRuntimeKey` | `composite-validator` | `pkg/invowkfile/implementation.go:73` |
...
| `PortMappingSpec` | `primitive-wrapper` | `pkg/invowkfile/port_mapping.go:32` |
| `RegexPattern` | `primitive-wrapper` | `pkg/invowkfile/regex_pattern.go:41` |
| `ContainerImage` | `primitive-wrapper` | `pkg/invowkfile/runtime.go:279` |
| `EnvInheritMode` | `primitive-wrapper` | `pkg/invowkfile/runtime.go:243` |
| `PlatformType` | `primitive-wrapper` | `pkg/invowkfile/runtime.go:258` |
| `RuntimeMode` | `primitive-wrapper` | `pkg/invowkfile/runtime.go:229` |
...
| `GlobPattern` | `primitive-wrapper` | `pkg/invowkfile/watch.go:57` |
| `WorkDir` | `primitive-wrapper` | `pkg/invowkfile/workdir.go:38` |
| `GitCommit` | `primitive-wrapper` | `pkg/invowkmod/git_types.go:74` |
| `GitURL` | `primitive-wrapper` | `pkg/invowkmod/git_types.go:53` |
| `Invowkmod` | `composite-validator` | `pkg/invowkmod/invowkmod.go:286` |
| `ModuleAlias` | `primitive-wrapper` | `pkg/invowkmod/invowkmod.go:336` |
| `ModuleID` | `primitive-wrapper` | `pkg/invowkmod/invowkmod.go:270` |
| `ModuleRequirement` | `composite-validator` | `pkg/invowkmod/invowkmod.go:412` |
| `SubdirectoryPath` | `primitive-wrapper` | `pkg/invowkmod/invowkmod.go:362` |
| `ValidationIssueType` | `primitive-wrapper` | `pkg/invowkmod/invowkmod.go:450` |
| `LockFileVersion` | `primitive-wrapper` | `pkg/invowkmod/lockfile.go:120` |
| `ModuleNamespace` | `primitive-wrapper` | `pkg/invowkmod/lockfile.go:105` |
| `ModuleRefKey` | `primitive-wrapper` | `pkg/invowkmod/lockfile.go:140` |
| `ModuleShortName` | `primitive-wrapper` | `pkg/invowkmod/module_short_name.go:45` |
| `ConstraintOp` | `primitive-wrapper` | `pkg/invowkmod/semver_types.go:119` |
| `SemVer` | `primitive-wrapper` | `pkg/invowkmod/semver_types.go:78` |
| `SemVerConstraint` | `primitive-wrapper` | `pkg/invowkmod/semver_types.go:98` |
| `SandboxType` | `primitive-wrapper` | `pkg/platform/sandbox.go:72` |
| `DescriptionText` | `primitive-wrapper` | `pkg/types/description.go:38` |
| `ExitCode` | `primitive-wrapper` | `pkg/types/exit_code.go:37` |
| `FilesystemPath` | `primitive-wrapper` | `pkg/types/filesystem_path.go:32` |
...
| `DiagnosticCode` | `string` | `internal/discovery/diagnostic.go:70` |
...
| `Severity` | `string` | `internal/discovery/diagnostic.go:67` |
