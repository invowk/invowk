...
11. **Baseline check passes**: `make check-baseline` - Verify no new primitivelint findings introduced. If findings are intentional, add exceptions to `exceptions.toml` or run `make update-baseline`.
