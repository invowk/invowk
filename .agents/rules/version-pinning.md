...
- **Current pinned versions:**
  ...
  - JDK: Temurin `25.0.4+7` in CI (`FORMAL_JAVA_VERSION` in `.github/workflows/formal-verification.yml`, installed with `actions/setup-java@v6` and checked with `java -version`); any Java 25 locally
