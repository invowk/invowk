// invowkmod_schema.cue - Schema definitions for module metadata (invowkmod.cue)
...
//
// The invowkmod.cue file is analogous to Go's go.mod - it contains:
...
// This file MUST exist in every .invowkmod directory
#Invowkmod: close({
	...
	// Example: folder "io.invowk.sample.invowkmod" must have module: "io.invowk.sample"
...
//   cue vet invowkmod.cue invowkmod_schema.cue -d '#Invowkmod'
