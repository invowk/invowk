...
// defaultValidateOptions returns the default validation options for an invkfile.
func defaultValidateOptions(inv *Invkfile) validateOptions {
	workDir := ""
...
// The fs.FS should be rooted at the invkfile's directory.
//
// Example for testing:
//
//	testFS := fstest.MapFS{
...
// Use this to validate an invkfile for a specific platform.
...
// By default, paths are resolved relative to the invkfile's directory.
...
func (o *validateOptions) buildValidationContext(inv *Invkfile) *ValidationContext {
	filesystem := o.fs
	if filesystem == nil {
