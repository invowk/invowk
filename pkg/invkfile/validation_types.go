...
type (
	...
	// ValidationError represents a single validation issue found during invkfile validation.
	...
	ValidationContext struct {
		...
		StrictMode bool
		// FilePath is the path to the invkfile being validated.
		FilePath string
	}
	...
	Validator interface {
		...
		Name() string
		// Validate checks the invkfile and returns all validation errors found.
