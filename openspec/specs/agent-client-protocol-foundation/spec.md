# agent-client-protocol-foundation Specification

## Purpose
Define the dormant internal Agent Client Protocol foundation for future stateful agent-session features while preserving current user-facing behavior.
