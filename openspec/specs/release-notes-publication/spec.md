# release-notes-publication Specification

## Purpose
Define the release notes publication contract so Invowk releases require reviewed markdown notes and publish that content as the GitHub Release body.
