...
// MustSetenv is a placeholder referencing the existing testutil.MustSetenv.
// In the actual implementation, SetHomeDir will call the real MustSetenv.
func MustSetenv(t testing.TB, key, value string) func() {
	// This is a contract placeholder.
	// Real implementation delegates to existing testutil.MustSetenv.
	return func() {}
}
