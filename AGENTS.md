...
This is the index for coding agent guidance. Use the links below for the full instructions.

## Quick Links

- [Overview](docs/agents/overview.md)
- [General Guidelines](docs/agents/guidelines.md)
- [Commands](docs/agents/commands.md)
- [Licensing](docs/agents/licensing.md)
- [Go Style](docs/agents/go-style.md)
- [Testing](docs/agents/testing.md)
- [CUE and Schemas](docs/agents/cue.md)
- [Invkfile Examples and Packs](docs/agents/invkfile-packs.md)
