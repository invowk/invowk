...
[`command plan`](../../tools/goplint/testdata/gates/clean-tree-v4.json),
[`path selection`](../../tools/goplint/testdata/gates/clean-tree-v4.paths),
[`counterexample inventory`](../../tools/goplint/testdata/gates/clean-tree-counterexamples-v3.json),
and the generated combined proof record `clean-tree-run.v4.json` (validated
