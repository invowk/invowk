...
| **Optional LLM Providers** | LLM-powered `invowk audit` analysis and `invowk agent cmd create` command authoring via Claude, Codex/OpenAI, Gemini, or local Ollama. | OpenAI-compatible HTTP APIs / local CLIs |
