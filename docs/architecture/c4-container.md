...
| **LLM Provider Layer** | Go | Provider adapters (`internal/auditllm/`, `internal/llm/`) used by audit analysis and command authoring to call CLI providers or OpenAI-compatible APIs. |
